...
namespace Hong.MailHelper
{
    public class MailHelper
    {
        ...
        public string Send(List<MailContent> data)
        {
            //成功寄出的數量
            int successCount = 0;
            ...
            {
                //如果收信人一個都沒有，直接失敗且跳下一個
                if(d.Recipient.Count() < 0) { errorCount += 1; continue; }
                ...
                try
                {
                    ...
                    msg.From = new MailAddress("XXX@gmail.com", "Hong", Encoding.UTF8);
